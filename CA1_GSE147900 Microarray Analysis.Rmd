...
#plots a pseudo-image of the chip intensities, just for fun
#image(gse147900_celdata[,1])
...
#added a simplified EB treatment column to pd because the other one had too much text
...
topTable_annotated <- AnnotationDbi::select(mta10transcriptcluster.db,topTable,
                      ...
                      keytype = "PROBEID")
#topTable_annotated <- merge((topTable[,c(1:4)]),topTable_annotated)           
